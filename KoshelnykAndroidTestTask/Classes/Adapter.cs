...
namespace KoshelnykAndroidTestTask.Classes
{
    class Adapter : BaseAdapter<string>
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            TextView messageTextView = row.FindViewById<TextView>(Resource.Id.messageTV);
            messageTextView.Text = mItems[position];
